...
class SinglePeptideDataModule(BaseDataModule):
    def __init__(
        ...
        super().__init__(
            batch_size=batch_size, num_workers=num_workers, pin_memory=pin_memory, eval_on_test=eval_on_test
        )
    ...
    def setup_potential(self):
        ...
        if self.hparams.sequence in ["Ace-A-Nme", "Ace-AAA-Nme"]:
            ...
            potential = OpenMMEnergy(bridge=OpenMMBridge(system, integrator, platform_name=self.hparams.platform_name))
        else:
